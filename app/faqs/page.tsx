...
const Faqs = () => {
    return (
        <section className=" overflow-x-hidden">
            <section
                className="flex flex-row gap-5 relative  justify-between bg-site-blue-100/80 px-6  pb-8 md:px-10 lg:px-12  xl:px-20   pt-[6rem] lg:pb-16 lg:pt-[7.5rem]  text-site-main "
                style={{
            ...
            >
                <div className="flex flex-col text-center md:text-start">
                    ...
                    <p className="w-full md:w-4/6 font-yaldevi  md:text-sm lg:text-base xl:text-xl leading-7 mt-4 tracking-wide">
                        ...
                        to celebrate their shared passions. Whether you're a
                        seasoned attendee or planning your first visit, this
                ...
                <figure className="absolute right-0 md:top-20 lg:top-0 aspect-square md:w-[16rem] lg:w-[22rem] xl:w-[27rem] z-5 overflow-hidden">
                    <Image
                        src={Images.default.ImageUrl.OF24_FLOURISH}
                        alt="logo"
                        fill
