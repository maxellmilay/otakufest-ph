    ...
    return (
        <section className="h-screen  flex flex-col font-yaldevi relative ">
            <CarouselBackground
                ...
                images={images}
            />
            <div className="absolute bg-black/30 bottom-0 flex flex-row md:justify-evenly items-center w-full p-5 sm:py-10 space-x-4 md:space-x-2 overflow-x-auto overflow-y-hidden hide-scrollbar">
                {news.map((card, index) => (
                    <CarouselCard
